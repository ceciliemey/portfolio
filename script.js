document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        heroName: { pt: "Cecilia Mayer", en: "Cecilia Mayer" }, 
        heroBio: { pt: "Transformo conceitos em experiências visuais intensas e memoráveis. Designer, ilustradora e criadora de interfaces com foco em UX/UI.", en: "I transform concepts into intense and memorable visual experiences. Designer, illustrator, and interface creator with a focus on UX/UI." },
        ...
        project1Title: { pt: "App de Tarefas (To-Do)", en: "To-Do App" },
        ...
        project2Title: { pt: "API de Cotações", en: "Quotation API" },
        ...
        project3Title: { pt: "Landing Page Moderna", en: "Modern Landing Page" },
        ...
        footerText: { pt: "© 2025 [Seu Nome]. Feito com paixão e código.", en: "© 2025 [Your Name]. Made with passion and code." }
    };
